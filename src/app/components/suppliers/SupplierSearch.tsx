...
export function SupplierSearch({ filters, onFiltersChange }: SupplierSearchProps) {
  ...
  return (
    <div className="mb-6">
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search suppliers by capability (e.g. CNC Machining, Sheet Metal, Injection Molding)..."
